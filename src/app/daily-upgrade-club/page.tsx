...
// ─── CTA Button ───────────────────────────────────────────────────────────────
function CTAButton({ label = "Start My 7-Day Trial — ₹1", sublabel }: { label?: string; sublabel?: string }) {
  return (
    ...
    <div style={{ background: "#faf8f3", minHeight: "100vh", fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
      ...
      <section style={{ background: "linear-gradient(180deg, #f0fdf4 0%, #faf8f3 100%)", borderBottom: "1px solid #e2dfd6" }}>
        <div className="max-w-2xl mx-auto px-5 py-14 text-center">
          ...
          <CTAButton
            label="Start My 7-Day Trial — ₹1 →"
            sublabel="Try free for 7 days · Then ₹99/month · Cancel anytime"
          />
      ...
      <section className="max-w-2xl mx-auto px-5 py-14">
        ...
        <div className="space-y-4">
          ...
          />
          <BeliefBreaker
            belief="What if I pay and don't use it?"
            truth="That's exactly why we give you 7 full days for ₹1. Experience the daily habits, the morning messages, the accountability — and only then decide. If it's not for you, cancel before day 7 and pay nothing more."
          />
        </div>
      </section>
      ...
      <section style={{ background: "#f0fdf4", borderTop: "1px solid #e2dfd6", borderBottom: "1px solid #e2dfd6" }} className="px-5 py-14">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <FeatureCard emoji="🌱" title="30 Tiny Daily Habits" desc="One carefully chosen habit every morning to improve your health, energy, and wellbeing — without overwhelming you." value="2,999" />
            <FeatureCard emoji="🎯" title="One Monthly Theme" desc="Go deep on one area — Health, Energy, Focus, Sleep, Fitness, or Productivity. One month, one transformation, measurable results." value="1,799" />
            <FeatureCard emoji="📲" title="Daily Accountability" desc="Simple daily check-ins on WhatsApp. Tap DONE to log your habit. No guilt if you miss — just gentle nudges to keep your streak alive." value="1,199" />
            <FeatureCard emoji="📊" title="Weekly Progress Scorecard" desc="Every week, see exactly how consistent you've been. Watch your energy, focus, and habits improve week by week with real data." value="999" />
            <FeatureCard emoji="🏆" title="Complete Habit Vault" desc="A growing library of powerful habits across every category. Over 90+ habits you can revisit and implement any time." value="999" />
            <FeatureCard emoji="👥" title="Private WhatsApp Group" desc="Build habits alongside others on the same journey. Share wins, stay accountable, and never feel like you're doing this alone." value="999" />
            <FeatureCard emoji="🗓️" title="Monthly Habit Calendar + PDF Guide" desc="Know exactly what's coming each day. Download your monthly guide and revisit every habit whenever you need it." value="499" />
            <FeatureCard emoji="📩" title="High Performance Newsletter" desc="Practical ideas, habit science, and weekly insights on health, focus, and wellbeing — curated and delivered to you." value="199" />
          </div>
        </div>
      </section>
      ...
      <section className="max-w-2xl mx-auto px-5 py-14">
        ...
        <div className="space-y-4">
          {[
            { q: "If all this did was", bold: "give you the energy to wake up every morning feeling actually alive", suffix: "— would 7 days for ₹1 be worth finding out?" },
            { q: "If all this did was", bold: "help you stay consistent for 30 days — building habits that actually stick this time", suffix: "— would that be worth ₹99 a month?" },
            { q: "If all this did was", bold: "give you the focus, the calm, and the health to show up fully for the people and work that matter most", suffix: "— would ₹3 per day feel like a fair trade?" },
          ].map(({ q, bold, suffix }, i) => (
      ...
      {/* ── SECTION 7: VALUE STACK + PRICE REVEAL ────────────────────────────── */}
      <section style={{ background: "#18181b" }} className="px-5 py-14">
        <div className="max-w-md mx-auto">
          ...
          <div className="rounded-2xl p-6 text-center" style={{ background: "linear-gradient(135deg, rgba(37,211,102,0.15) 0%, rgba(29,168,81,0.1) 100%)", border: "1px solid rgba(37,211,102,0.3)" }}>
            <p className="text-sm font-bold uppercase tracking-widest mb-3" style={{ color: "#25d366" }}>Your Price Today</p>
            {/* Trial price */}
            <div className="flex items-baseline justify-center gap-2 mb-1">
              <span style={{ fontSize: "5rem", lineHeight: 1, fontWeight: 900, letterSpacing: "-0.04em", color: "#25d366" }}>₹1</span>
            </div>
            <p className="text-base font-semibold mb-1" style={{ color: "#ffffff" }}>for your first 7 days</p>
            <p className="text-sm mb-5" style={{ color: "#71717a" }}>Then just ₹99/month — that&apos;s ₹3 per day. Less than one cup of chai.</p>
            <CTAButton label="Start My 7-Day Trial → ₹1" />
            <p className="text-xs mt-3" style={{ color: "#52525b" }}>Cancel before day 7 and pay nothing more.</p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-2xl mx-auto px-5 py-14">
        ...
        <div className="space-y-4">
          {[
            ...
            { step: "2", title: "Start your 7-day trial for ₹1", desc: "Complete your ₹1 payment. We'll add you to the Daily Upgrade Club and set everything up on WhatsApp within minutes." },
            ...
            { step: "4", title: "Love it → continue at ₹99/month", desc: "After your 7-day trial, your subscription continues at ₹99/month. Cancel anytime — no questions asked." },
          ].map(({ step, title, desc }) => (
      ...
      <section style={{ background: "#f0fdf4", borderTop: "1px solid #e2dfd6", borderBottom: "1px solid #e2dfd6" }} className="px-5 py-14">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              { name: "Karan M.", city: "Pune", text: "I tried the ₹1 trial just to see. By day 3, I was already feeling the difference. Never cancelled.", avatar: "/avatars/men/man-1.jpg" },
      ...
      <section className="max-w-2xl mx-auto px-5 py-14">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
          <div className="rounded-2xl p-6 text-center" style={{ background: "white", border: "1px solid #e2dfd6", boxShadow: "0 2px 8px rgba(0,0,0,0.04)" }}>
            ...
            <p className="font-bold mb-2" style={{ color: "#18181b" }}>7-Day Trial for ₹1</p>
            <p className="text-sm leading-relaxed" style={{ color: "#71717a" }}>Try the entire Daily Upgrade Club for 7 days at just ₹1. If you don&apos;t love it, cancel before day 7 and you&apos;ll never be charged again. Zero risk.</p>
          </div>
        ...
        <div className="text-center">
          ...
          <CTAButton
            label="Start My 7-Day Trial → ₹1"
            sublabel="Then ₹99/month · Cancel anytime before day 7"
          />
        </div>
      </section>
      ...
      <section style={{ background: "#18181b" }} className="px-5 py-14">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="space-y-3">
            {[
              { q: "What happens after my 7-day trial?", a: "After 7 days, your subscription automatically continues at ₹99/month. You'll receive a reminder before the trial ends. Cancel anytime before day 7 and you won't be charged." },
      ...
      <section style={{ background: "linear-gradient(135deg, #f0fdf4 0%, #faf8f3 100%)", borderTop: "1px solid #e2dfd6" }} className="px-5 py-16">
        <div className="max-w-xl mx-auto text-center">
          ...
          <CTAButton
            label="Yes, I'm Ready — Start for ₹1 →"
            sublabel="7-day trial · Then ₹99/month · Cancel anytime"
          />
      ...
      <footer className="px-5 py-8 text-center" style={{ background: "#111111", borderTop: "1px solid rgba(255,255,255,0.06)" }}>
        ...
        <p className="text-xs mt-2" style={{ color: "#3f3f46" }}>
          All prices in INR · 7-day trial ₹1, then ₹99/month · Cancel anytime
        </p>
      </footer>
