    ...
    <div className={`fixed bottom-0 inset-x-0 z-50 transition-all duration-300 ${visible ? "translate-y-0 opacity-100" : "translate-y-full opacity-0 pointer-events-none"}`}>
      <div className="px-4 pb-3 pt-2 md:hidden" style={{ background: "linear-gradient(to top,#faf8f3 70%,transparent)", backdropFilter: "blur(8px)" }}>
        <a href="#" onClick={(e) => { e.preventDefault(); openDUCCheckout(); }} className="cursor-pointer w-full flex items-center justify-between gap-3 rounded-2xl px-5 py-3" style={{ background: "linear-gradient(135deg,#1da851,#25d366)", boxShadow: "0 4px 20px rgba(37,211,102,0.4)", textDecoration: "none" }}>
          <div><p className="text-white font-black text-sm leading-tight">Join for Just ₹99/month →</p><p className="text-xs mt-0.5" style={{ color: "rgba(255,255,255,0.8)" }}>1 healthy habit daily · less than a chai a day</p></div>
      ...
      <div className="hidden md:block px-6 pb-4 pt-3" style={{ background: "linear-gradient(to top,#faf8f3 70%,transparent)", backdropFilter: "blur(8px)" }}>
        <div className="max-w-lg mx-auto">
          <a href="#" onClick={(e) => { e.preventDefault(); openDUCCheckout(); }} className="cursor-pointer w-full flex items-center justify-between gap-4 rounded-2xl px-6 py-3.5" style={{ background: "linear-gradient(135deg,#1da851,#25d366)", boxShadow: "0 4px 20px rgba(37,211,102,0.4)", textDecoration: "none" }}>
            <div><p className="text-white font-black text-sm leading-tight">Join for Just ₹99/month — Daily Habits on WhatsApp →</p><p className="text-xs mt-0.5" style={{ color: "rgba(255,255,255,0.8)" }}>Just ₹99 per month · 1 healthy habit every morning for 30 days</p></div>
      ...
      <div className="fixed inset-0 z-[101] flex items-center justify-center px-4 pointer-events-none">
        <div className="pointer-events-auto w-full max-w-sm rounded-3xl overflow-hidden" onClick={e => e.stopPropagation()} style={{ background: "#fff", boxShadow: "0 20px 60px rgba(0,0,0,0.22)", animation: "duc-fadein 0.35s ease" }}>
          ...
          <div className="px-6 py-5 text-center">
            ...
            <p style={{ fontSize: 12, color: "#a1a1aa", marginTop: 8 }}>Just ₹99 per month · 1 healthy habit every morning for 30 days</p>
          </div>
        </div>
      </div>
    </>
  ...
  return (
    <div id="duc-top" style={{ background: "#faf8f3", minHeight: "100vh", color: "#18181b", fontSize: 15 }}>
            ...
            <div className="lg:col-span-7 text-center lg:text-left">
              ...
              <div className="animate-fade-up delay-150 mb-7 max-w-lg mx-auto lg:mx-0 relative">
                <p style={{ fontSize: 16, lineHeight: 1.75, color: "#52525b" }}>
                  ...
                  sends you 1 science-backed healthy habit every morning for next 30 days — plus monthly habit themes, community access, personal accountability &amp; streak tracking designed to help you become healthier &amp; happier every day.
                </p>
              ...
              <div className="animate-fade-up delay-300 flex flex-col items-center lg:items-start gap-2 mb-8">
                <button
                  ...
                  <WAIcon size={22} />Join for Just ₹99/month →
                </button>
                <p style={{ fontSize: 13, color: "#71717a", textAlign: "center" }}>Just ₹99 per month — that's ₹3.3 a day, less than your daily cup of chai ☕</p>
              </div>
      ...
      <section className="bg-section-white py-16 lg:py-24">
        <div className="max-w-4xl mx-auto px-6 lg:px-10">
          ...
          <div className="rounded-2xl overflow-hidden border" style={{ borderColor: "#e4e4e7", background: "#fff", boxShadow: "0 12px 40px -14px rgba(0,0,0,0.15)" }}>
            ...
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/goals/shift-before-after-v5.png" alt="Before and after across energy, sleep and health after 30 days" style={{ display: "block", width: "100%", height: "auto" }} loading="lazy" />
                ...
                <div className="relative">
                  ...
                  <div className="flex flex-col gap-3.5">
                    {[
                      ...
                      "\"I've been consistent for 30 days straight\"",
                    ].map((a, i) => (
        ...
        <div className="max-w-3xl mx-auto px-6 lg:px-10">
          ...
          <div className="flex flex-col gap-4">
            {[
              ...
              { icon: "🔄", bold: "make you the person who actually follows through on their health for 30 straight days — not just the first week", cta: "— would just ₹99 a month be worth it?" },
          ...
          <div className="rounded-2xl premium-card p-7 sm:p-10 border-glow relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                {[
                  { icon: "🔒", t: "One-time payment", b: "Just ₹99/month. No auto-charges. No hidden fees." },
              ...
              <div className="text-center">
                ...
                <CTA label="Yes — I Have Nothing to Lose →" sub="Just ₹99 per month · 7-day money-back promise" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-xl mx-auto px-6 text-center relative">
          ...
          <div className="mt-10 rounded-xl p-6 text-left" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.07)" }}>
            <p style={{ fontSize: 14, color: "#a1a1aa", lineHeight: 1.75 }}>
              <strong style={{ color: "#e4e4e7" }}>P.S.</strong> — The cost of doing nothing is not ₹0. Every month you spend feeling low energy, sleeping poorly, or saying &ldquo;I&apos;ll start next week&rdquo; has a real cost — in how you feel, what you achieve, and who you become. a full month of daily habits costs just ₹99 — ₹3.3 a day, less than your daily chai. The real question isn&apos;t whether ₹99 a month is worth it. It&apos;s: how long do you want to keep waiting?
            </p>
          </div>
        </div>
      </section>
      ...
      <footer className="px-5 py-6 text-center" style={{ background: "#0a0a0a", borderTop: "1px solid rgba(255,255,255,0.05)" }}>
        ...
        <p style={{ fontSize: 12, color: "#3f3f46", marginTop: 4 }}>Just ₹99 per month · 1 daily habit for 30 days · No auto-charges</p>
      </footer>
