...
export const metadata: Metadata = {
  title:
    "Free Masterclass: Get Healthy While You Work | The Desk Health System™",
  description:
  ...
  openGraph: {
    ...
    description:
      "Improve your health naturally while you work — better posture, energy and focus — with tiny daily desk habits. No gym, no diet, no extra hours. Free live masterclass on the Desk Health System™.",
    type: "website",
    locale: "en_IN",
