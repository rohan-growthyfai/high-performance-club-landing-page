...
export const metadata: Metadata = {
  ...
  description:
    "Your desk job is slowly damaging your health — poor posture, low energy, eye strain, stiffness, stress. Join this FREE live masterclass and learn how to improve your health naturally while you work, with quick daily habits. No gym, no diet, no extra hours. The Desk Fit Formula — for anyone who works 6+ hours a day at a desk.",
  keywords: [
    "desk health",
    "desk health system",
    "posture at work",
  ...
  openGraph: {
    ...
    description:
      "Improve your health naturally while you work — better posture, energy and focus — with quick daily desk habits. No gym, no diet, no extra hours. Free live masterclass on the Desk Fit Formula.",
    type: "website",
    locale: "en_IN",
