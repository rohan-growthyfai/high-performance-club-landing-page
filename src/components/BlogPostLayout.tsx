...
export default function BlogPostLayout({
  ...
  return (
    <div style={{ background: "#0c0c0f", minHeight: "100vh", fontFamily: "var(--font-sans)", color: "#f5f5f7" }}>
      <style>{`
        .blog-content p {
          font-size: 17px; line-height: 1.85; color: rgba(255,255,255,0.65);
          margin-bottom: 24px; font-weight: 400;
        }
        .blog-content h2 {
          font-size: 24px; font-weight: 800; color: #f5f5f7;
        ...
        .callout p { color: rgba(255,255,255,0.6) !important; margin-bottom: 16px; }
        .callout a {
      ...
      {/* Header */}
      <header style={{
        background: "rgba(12,12,15,0.9)", backdropFilter: "blur(20px)",
        ...
        <Link href="/" style={{ display: "flex", alignItems: "center", gap: 10, textDecoration: "none" }}>
          ...
          <span style={{ fontWeight: 700, fontSize: 16, color: "#f5f5f7", letterSpacing: "-0.02em" }}>High Performance Club</span>
        </Link>
        <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
          <Link href="/blogs" style={{ fontSize: 14, color: "rgba(255,255,255,0.4)", textDecoration: "none", fontWeight: 500 }}>Blog</Link>
      ...
      <main style={{ maxWidth: 740, margin: "0 auto", padding: "64px 32px 120px" }}>
        {/* Back link */}
        <Link href="/blogs" style={{ display: "inline-flex", alignItems: "center", gap: 6, fontSize: 13, color: "rgba(255,255,255,0.3)", textDecoration: "none", marginBottom: 52, fontWeight: 600, letterSpacing: "0.02em", transition: "color 0.2s" }}>
          ← All articles
        </Link>
        ...
        <div style={{ marginBottom: 56 }}>
          <div style={{ display: "flex", gap: 10, alignItems: "center", marginBottom: 24, flexWrap: "wrap" }}>
            ...
            <span style={{ fontSize: 13, color: "rgba(255,255,255,0.25)" }}>{readTime}</span>
            <span style={{ fontSize: 13, color: "rgba(255,255,255,0.25)" }}>· {date}</span>
          </div>
        ...
        {/* Bottom nav */}
        <div style={{ marginTop: 72, paddingTop: 32, borderTop: "1px solid rgba(255,255,255,0.06)", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12 }}>
          <Link href="/blogs" style={{ fontSize: 14, color: "rgba(255,255,255,0.3)", textDecoration: "none", fontWeight: 600 }}>← All articles</Link>
      ...
      {/* Footer */}
      <footer style={{ borderTop: "1px solid rgba(255,255,255,0.05)", padding: "28px 32px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12 }}>
        <p style={{ fontSize: 13, color: "rgba(255,255,255,0.2)" }}>© 2026 High Performance Club</p>
        <div style={{ display: "flex", gap: 24 }}>
          <Link href="/" style={{ fontSize: 13, color: "rgba(255,255,255,0.25)", textDecoration: "none" }}>Home</Link>
