      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 text-center lg:text-left">
            ...
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-5 animate-fade-up" style={{ background: "rgba(76,175,110,0.1)", border: "1px solid rgba(76,175,110,0.3)" }}>
              <span className="w-2.5 h-2.5 rounded-full inline-block" style={{ background: "#4caf6e" }} />
              <span className="text-sm font-bold tracking-wide" style={{ color: "#3d9b5a" }}>FREE 7-Day WhatsApp Challenge</span>
            </div>
