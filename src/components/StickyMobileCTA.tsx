...
export default function StickyMobileCTA() {
  ...
  return (
    ...
    >
      ...
      {/* Desktop — same green card design as mobile, full width */}
      <div className="hidden md:block px-6 pb-4 pt-3" style={{ background: "linear-gradient(to top, #fff 70%, transparent)", backdropFilter: "blur(8px)" }}>
        <div className="max-w-2xl mx-auto">
          <a
            href="https://wa.me/918956146485?text=Hi%21+I+want+to+start+my+Healthy+Habits+Challenge"
            target="_blank"
            rel="noopener noreferrer"
            className="w-full flex items-center justify-between gap-3 rounded-2xl px-6 py-4 shadow-[0_4px_24px_rgba(37,211,102,0.35)]"
            style={{ background: "linear-gradient(135deg, #25d366 0%, #1aa84f 100%)" }}
          >
            <div className="text-left">
              <p className="text-white font-bold text-base leading-tight">Join FREE on WhatsApp</p>
              <p className="text-white/80 text-sm leading-tight mt-0.5">7-Day Healthy Habits Challenge 🔥</p>
            </div>
