...
const INIT: Phase = {
  headerStatus: "online · 1,240 members",
  msg1Visible: false,
  reply1Visible: false,
  reply1Ticks: "none",
  msg2Visible: false,
      ...
      <div style={{
        ...
        <div style={{ borderRadius: 36, overflow: "hidden", background: "#000" }}>
          ...
          <div style={{ background: "#202c33", padding: "8px 16px 6px", display: "flex", alignItems: "center", justifyContent: "space-between", fontSize: 11, color: "rgba(255,255,255,0.85)", fontFamily: "var(--font-sans)", fontWeight: 600 }}>
            <span>9:41</span>
            <div style={{ display: "flex", gap: 4, alignItems: "center" }}><span style={{ fontSize: 10, fontWeight: 700 }}>100%</span></div>
          </div>
          <div style={{ background: "#202c33", padding: "8px 12px 10px", display: "flex", alignItems: "center", gap: 10, borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
            <div style={{ width: 38, height: 38, borderRadius: "50%", overflow: "hidden", flexShrink: 0, border: "1.5px solid rgba(255,255,255,0.12)" }}>
              <img src="/hpc-logo.png" alt="Daily Upgrade Club" style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }} />
            </div>
            ...
            {phase.msg1Visible && (
              <div className="wa-anim-in-left" style={{ display: "flex", paddingLeft: 6 }}>
                <div style={{ background: "#202c33", borderRadius: "8px 8px 8px 0", padding: "8px 10px", maxWidth: "85%", position: "relative" }}>
                  ...
                  <p style={{ margin: 0, color: "#25d366", fontSize: 11, fontWeight: 700, fontFamily: "var(--font-sans)" }}>🎯 Day 4 — Focus Start Habit</p>
                  <p style={{ margin: "5px 0 0", color: "rgba(255,255,255,0.88)", fontSize: 11.5, fontFamily: "var(--font-sans)", lineHeight: 1.5 }}>Before opening Instagram or WhatsApp, write your first important task. Takes 30 seconds.</p>
                  <p style={{ margin: "4px 0 0", color: "rgba(255,255,255,0.6)", fontSize: 11, fontFamily: "var(--font-sans)", lineHeight: 1.4 }}>Once done, reply <strong>DONE ✅</strong></p>
                  <p style={{ margin: "4px 0 0", color: "rgba(255,255,255,0.55)", fontSize: 10, fontFamily: "var(--font-sans)", textAlign: "right" }}>6:00 AM</p>
                </div>
              </div>
            )}
            {phase.reply1Visible && (
              <div className="wa-anim-in-right" style={{ display: "flex", justifyContent: "flex-end", paddingRight: 6 }}>
                <div style={{ background: "#005c4b", borderRadius: "8px 8px 0 8px", padding: "7px 10px", maxWidth: "55%", position: "relative" }}>
                  ...
                  <p style={{ margin: "3px 0 0", color: "rgba(255,255,255,0.5)", fontSize: 10, fontFamily: "var(--font-sans)", textAlign: "right", display: "flex", gap: 4, justifyContent: "flex-end", alignItems: "center" }}>
                    <span>6:04 AM</span><Tick state={phase.reply1Ticks} />
                  </p>
                </div>
              </div>
            )}
            {phase.msg2Visible && (
              <div className="wa-anim-in-left" style={{ display: "flex", paddingLeft: 6 }}>
                <div style={{ background: "#202c33", borderRadius: "8px 8px 8px 0", padding: "8px 10px", maxWidth: "85%", position: "relative" }}>
                  ...
                  <p style={{ margin: "4px 0 0", color: "rgba(255,255,255,0.75)", fontSize: 11.5, fontFamily: "var(--font-sans)", lineHeight: 1.5 }}>This week: <strong>4/7</strong> habits ✅<br />This month: <strong>12/30</strong> habits<br />Streak: <strong>3 days</strong> 🔥</p>
                  <p style={{ margin: "4px 0 0", color: "rgba(255,255,255,0.55)", fontSize: 10, fontFamily: "var(--font-sans)", textAlign: "right" }}>6:04 AM</p>
                </div>
              </div>
            )}
            {phase.reply2Visible && (
              <div className="wa-anim-in-right" style={{ display: "flex", justifyContent: "flex-end", paddingRight: 6 }}>
                <div style={{ background: "#005c4b", borderRadius: "8px 8px 0 8px", padding: "7px 10px", maxWidth: "70%", position: "relative" }}>
                  <div style={{ position: "absolute", bottom: 0, right: -7, width: 0, height: 0, borderStyle: "solid", borderWidth: "0 0 8px 8px", borderColor: "transparent transparent #005c4b transparent" }} />
                  <p style={{ margin: 0, color: "#fff", fontSize: 12, fontFamily: "var(--font-sans)" }}>Love this system! 🚀</p>
                  <p style={{ margin: "3px 0 0", color: "rgba(255,255,255,0.5)", fontSize: 10, fontFamily: "var(--font-sans)", textAlign: "right", display: "flex", gap: 4, justifyContent: "flex-end", alignItems: "center" }}>
                    <span>6:05 AM</span><Tick state={phase.reply2Ticks} />
                  </p>
                </div>
              </div>
            )}
