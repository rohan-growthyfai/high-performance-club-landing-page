...
export default function DUCPhone({ dark }: { dark?: boolean }) {
  ...
  return (
    <div ref={ref} className="relative mx-auto select-none" style={{ width: 270 }}>
      <div style={{ background: "linear-gradient(160deg, #2a2a2a 0%, #1a1a1a 40%, #111 100%)", borderRadius: 44, padding: "10px 8px", boxShadow: ["0 0 0 1px #3a3a3a","0 0 0 2px #111","0 32px 64px -12px rgba(0,0,0,0.7)","0 12px 32px -8px rgba(0,0,0,0.5)","inset 0 1px 0 rgba(255,255,255,0.08)"].join(", "), position: "relative" }}>
            ...
            {phase.msg1Visible && (
              <div className="wa-anim-in-left" style={{ display: "flex", paddingLeft: 6 }}>
                <div style={{ background: "#202c33", borderRadius: "8px 8px 8px 0", padding: "8px 10px", maxWidth: "88%", position: "relative" }}>
                  ...
                  <p style={{ margin: "3px 0 0", color: "rgba(255,255,255,0.6)", fontSize: 11, fontFamily: "var(--font-sans)" }}>Time: <strong style={{ color: "rgba(255,255,255,0.8)" }}>30 seconds</strong></p>
                  <p style={{ margin: "5px 0 0", color: "rgba(255,255,255,0.8)", fontSize: 11.5, fontFamily: "var(--font-sans)" }}>Reply <strong>DONE</strong> ✅ when done</p>
                  <p style={{ margin: "4px 0 0", color: "rgba(255,255,255,0.4)", fontSize: 10, textAlign: "right", fontFamily: "var(--font-sans)" }}>6:00 AM</p>
                </div>
              </div>
            )}
            {phase.reply1Visible && (
