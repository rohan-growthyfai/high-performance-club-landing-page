        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative mx-auto select-none" style={{ width: 270 }}>
              ...
              <div className="relative" style={{ background: "linear-gradient(160deg, #2a2a2a 0%, #1a1a1a 40%, #111 100%)", borderRadius: 44, padding: "10px 8px", boxShadow: "0 0 0 1px #3a3a3a, 0 0 0 2px #111, 0 32px 64px -12px rgba(0,0,0,0.55), inset 0 1px 0 rgba(255,255,255,0.08)" }}>
                ...
                <div style={{ borderRadius: 36, overflow: "hidden", background: "#000" }}>
                  ...
                  <div style={{ background: "#0b141a", padding: "12px 8px 16px", minHeight: 380, display: "flex", flexDirection: "column", gap: 8 }}>
                    ...
                    <div style={{ display: "flex", paddingLeft: 6 }}>
                      <div style={{ background: "#202c33", borderRadius: "8px 8px 8px 0", padding: "10px 12px", maxWidth: "90%", position: "relative" }}>
                        ...
                        <p style={{ margin: "0 0 8px", color: "rgba(255,255,255,0.9)", fontSize: 11.5, fontFamily: "var(--font-sans)", lineHeight: 1.55 }}>Before opening Instagram, YouTube, or WhatsApp today — write your ONE most important task first.</p>
                        <p style={{ margin: "0 0 8px", color: "rgba(255,255,255,0.55)", fontSize: 10.5, fontFamily: "var(--font-sans)" }}>⏱ Time needed: <span style={{ color: "rgba(255,255,255,0.85)", fontWeight: 600 }}>30 seconds</span></p>
                        <div style={{ borderTop: "1px solid rgba(255,255,255,0.08)", paddingTop: 8, marginBottom: 8 }}>
                          <p style={{ margin: "0 0 3px", color: "rgba(255,255,255,0.4)", fontSize: 9.5, fontFamily: "var(--font-sans)", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.08em" }}>Why this works</p>
                          <p style={{ margin: 0, color: "rgba(255,255,255,0.7)", fontSize: 11, fontFamily: "var(--font-sans)", lineHeight: 1.5 }}>Gives your brain one clear direction before distractions take over.</p>
                        </div>
                        <p style={{ margin: 0, color: "rgba(255,255,255,0.85)", fontSize: 11.5, fontFamily: "var(--font-sans)" }}>Reply <strong style={{ color: "#fff" }}>DONE</strong> ✅ when done</p>
                        <p style={{ margin: "5px 0 0", color: "rgba(255,255,255,0.3)", fontSize: 10, textAlign: "right", fontFamily: "var(--font-sans)" }}>6:00 AM</p>
                      </div>
                    </div>
                    {/* User reply */}
                    <div style={{ display: "flex", justifyContent: "flex-end", paddingRight: 6 }}>
                      <div style={{ background: "#005c4b", borderRadius: "8px 8px 0 8px", padding: "8px 12px", maxWidth: "50%", position: "relative" }}>
                        ...
                        <p style={{ margin: "3px 0 0", color: "rgba(255,255,255,0.4)", fontSize: 10, textAlign: "right", fontFamily: "var(--font-sans)" }}>6:07 AM ✓✓</p>
                      </div>
                    </div>
                    {/* Tracking reply */}
                    <div style={{ display: "flex", paddingLeft: 6 }}>
                      <div style={{ background: "#202c33", borderRadius: "8px 8px 8px 0", padding: "10px 12px", maxWidth: "85%", position: "relative" }}>
                        <div style={{ position: "absolute", bottom: 0, left: -7, width: 0, height: 0, borderStyle: "solid", borderWidth: "0 0 8px 8px", borderColor: "transparent transparent #202c33 transparent" }} />
                        <p style={{ margin: "0 0 5px", color: "#fff", fontSize: 12, fontFamily: "var(--font-sans)" }}>Done counted ✅</p>
                        <p style={{ margin: 0, color: "rgba(255,255,255,0.75)", fontSize: 11.5, fontFamily: "var(--font-sans)", lineHeight: 1.6 }}>Streak: <strong style={{ color: "#25d366" }}>4 days 🔥</strong><br />Month: <strong style={{ color: "#fff" }}>12/30 habits</strong></p>
                        <p style={{ margin: "5px 0 0", color: "rgba(255,255,255,0.3)", fontSize: 10, textAlign: "right", fontFamily: "var(--font-sans)" }}>6:07 AM</p>
                      </div>
                    </div>
                  </div>
          ...
          <div className="space-y-8">
            {[
              ...
              { num: "02", label: "Clear enough to follow.", sub: "No interpretation needed. Read it. Do it. Reply DONE. That's the whole system." },
              { num: "03", label: "Small enough to repeat.", sub: "That's exactly how habits form — not through heroics, but through consistent repetition." },
            ].map(item => (
