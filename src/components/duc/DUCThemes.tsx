      ...
      <div className="max-w-5xl mx-auto px-6 lg:px-8">
        ...
        <div className="mb-16">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end gap-6 lg:justify-between">
            <h2 style={{ fontSize: "clamp(2rem, 4vw, 3rem)", lineHeight: 1.1, letterSpacing: "-0.025em", fontWeight: 800, color: "#fafafa" }}>
              One month.<br />
              <span style={{ color: "#444", fontStyle: "italic", fontWeight: 400 }}>One focus.</span>
            </h2>
            <p className="text-[#666] text-sm max-w-xs leading-relaxed">No random tips. Every month follows one focused theme so your habits compound.</p>
          </div>
        </div>

        <div className="grid grid-cols-2 lg:grid-cols-3 gap-px bg-white/5 rounded-3xl overflow-hidden">
          {themes.map(theme => (
            <div key={theme.name} className="bg-[#0a0a0a] p-7 hover:bg-[#111] transition-colors group">
              ...
              <p className="text-[#555] text-xs leading-relaxed">{theme.desc}</p>
            </div>
          ))}
        </div>
        ...
        <div className="mt-10 text-center">
          <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-white/4 border border-white/8">
            <span className="text-sm text-[#888]">Thirty habits. One theme. One month.</span>
          </div>
        </div>
      </div>
    </section>
